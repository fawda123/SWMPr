...
# qaqc and subset imported data
dat <- qaqc(swmp1)
dat <- subset(dat, subset = c('2013-01-01 00:00', '2013-07-31 00:00'))

# interpolate, maxgap of 10 records
test <- decomp(dat, param = 'do_mgl', s.window = 'periodic', na.action = na.exclude)
...
`decomp.swmpr` Decompose a swmpr time series into seasonal, trend, and residual components.  This is a simple wrapper to `stl`.
