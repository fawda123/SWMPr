...
Linux and OS X: [![Travis-CI Build Status](https://travis-ci.org/fawda123/SWMPr.png?branch=development)](https://travis-ci.org/fawda123/SWMPr)

Windows: [![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/fawda123/SWMPr?branch=development)](https://ci.appveyor.com/project/fawda123/SWMPr)
