...
*Beck MW. 2016. SWMPr: An R package for retrieving, organizing, and analyzing environmental data for estuaries.  The R Journal. In press. https://journal.r-project.org/archive/accepted/beck.pdf*
