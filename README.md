...
Linux and OS X: [![Build Status](https://travis-ci.org/fawda123/SWMPr.svg?branch=master)](https://travis-ci.org/fawda123/SWMPr)

Windows: [![Build status](https://ci.appveyor.com/api/projects/status/kouqfwfx6bnk13qq?svg=true)](https://ci.appveyor.com/project/fawda123/swmpr)
